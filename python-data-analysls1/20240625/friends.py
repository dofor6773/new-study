...
os.chdir(r'c:\Users\human-33\python-data-analysls1\20240625')
...
# print('-' * 150)
# print(set(re.findall(r'[A-Z][a_z]+: ', script101)))
...
print(len(re.findall('\([A-Za-z].+?[a-z|\.]\)', script101))) # 97개의 지문이 있음
